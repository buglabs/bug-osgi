 ...
 * A modulus operator.
 * 
 * @version $Id: Modulo.java 1123 2005-10-04 10:48:25Z run2000 $
 * @since 1.8
 */
public final class Modulo extends AbstractBinary implements Serializable {

	/** Serialization UUID for this class. */
	private static final long serialVersionUID = -2802709853446362855L;
	...
	public void setLeft(Expression left) {
		if ((left.getType() & ExpressionUtils.EXPRESSION_TYPE_NUMBER) == 0) {
			throw new IllegalArgumentException("Numeric expression is required for modulo operation");
		}
		super.setLeft(left);
	}
	...
	/**
	 * Performs a modulus of the two number models set previously. One is
	 * divided by the other, and the remainder is returned. If either of the
