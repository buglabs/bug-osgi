 ...
 * 
 * @version $Id: GreaterThan.java 1123 2005-10-04 10:48:25Z run2000 $
 * @since 1.8
 */
public final class GreaterThan extends AbstractBinary implements Serializable {

	/** Serialization UUID for this class. */
	private static final long serialVersionUID = -8650265447544578319L;
	...
	public void setLeft(Expression left) {
		if ((left.getType() & ExpressionUtils.EXPRESSION_TYPE_NUMBER) == 0) {
			throw new IllegalArgumentException("Numeric expression is required for greaterthan operation");
		}
		super.setLeft(left);
	}
