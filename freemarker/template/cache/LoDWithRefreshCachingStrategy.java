...
/**
 * Implements a load-on-demand caching strategy with periodic refreshes. The
 * main difference between this and the plain load-on-demand strategy is that we
 * only update the templates when the timer fires, rather than every time the
 * cache item is accessed.
 * 
 * @author Nicholas Cull
 * @version $Id: LoDWithRefreshCachingStrategy.java 995 2004-10-15 04:05:41Z
 *          run2000 $
 * @since 1.8
 */
public final class LoDWithRefreshCachingStrategy extends BaseCachingStrategy {
	...
	public LoDWithRefreshCachingStrategy() {
	}
	...
	public String toString() {
		...
		buffer.append("LoDWithRefreshCachingStrategy, ");
