 ...
 * 
 * @version $Id: LessThan.java 1123 2005-10-04 10:48:25Z run2000 $
 * @since 1.8
 */
public final class LessThan extends AbstractBinary implements Serializable {

	/** Serialization UUID for this class. */
	private static final long serialVersionUID = 2864919600163631996L;
	...
	public void setLeft(Expression left) {
		if ((left.getType() & ExpressionUtils.EXPRESSION_TYPE_NUMBER) == 0) {
			throw new IllegalArgumentException("Numeric expression is required for lessthan operation");
		}
		super.setLeft(left);
	}
