 ...
 * 
 * @version $Id: GreaterThanOrEquals.java 1123 2005-10-04 10:48:25Z run2000 $
 * @since 1.8
 */
public final class GreaterThanOrEquals extends AbstractBinary implements Serializable {

	/** Serialization UUID for this class. */
	private static final long serialVersionUID = -5966279948497867849L;
	 ...
	 *             the key could not be evaluated as a number
	 */
	public void setLeft(Expression left) {
		if ((left.getType() & ExpressionUtils.EXPRESSION_TYPE_NUMBER) == 0) {
			throw new IllegalArgumentException("Numeric expression is required for greaterthanorequals operation");
		}
		super.setLeft(left);
	}
	...
	/**
	 * Performs a comparison on the two number models set previously. One is
	 * subtracted from the other, then compared against zero. If either of the
	 * values is not a number, an exception is thrown.
	 * 
	 * @param modelRoot
	...
	public int getPrecedence() {
		return ExpressionBuilder.PRECEDENCE_COMPARISON;
	}
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof GreaterThanOrEquals)) {
			return false;
		}
