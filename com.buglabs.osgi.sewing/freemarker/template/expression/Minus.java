 ...
 * 
 * @version $Id: Minus.java 1123 2005-10-04 10:48:25Z run2000 $
 * @since 1.8
 */
public final class Minus extends AbstractBinary implements Serializable {

	/** Serialization UUID for this class. */
	private static final long serialVersionUID = 4470277953822447127L;
	...
	public void setLeft(Expression left) {
		if ((left.getType() & ExpressionUtils.EXPRESSION_TYPE_NUMBER) == 0) {
			throw new IllegalArgumentException("Numeric expression is required for minus operation");
		}
		super.setLeft(left);
	}
	...
	/**
	 * Performs subtraction on the two number models set previously. One is
	 * subtracted from the other using normal arithmetic, then returned. If
	 * either of the values is not a number, an exception is thrown.
	 * 
	 * @param modelRoot
