 ...
 * 
 * @version $Id: Equals.java 1123 2005-10-04 10:48:25Z run2000 $
 */
public final class Equals extends AbstractBinary implements Serializable {

	/** Serialization UUID for this class. */
	private static final long serialVersionUID = -1593556381284363855L;
	...
	public void setLeft(Expression left) {
		if ((left.getType() & (ExpressionUtils.EXPRESSION_TYPE_STRING | ExpressionUtils.EXPRESSION_TYPE_NUMBER)) == 0) {
			throw new IllegalArgumentException("Scalar or numeric required for equals expression");
		}
		super.setLeft(left);
	}
	...
	/**
	 * The {@link freemarker.template.TemplateModel} value of this equality
	 * test.
	 * 
	 * @param modelRoot
	 *            the template model that will be evaluated by the expression
	 * @return a <code>FastBoolean</code> indicating whether the two sides of
