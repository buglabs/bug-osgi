...
public class Criteria {
	...
	final com.openlapi.Criteria wrapped;
	 ...
	 */
	public Criteria() {
		wrapped = new com.openlapi.Criteria();
	}
	...
	public int getPreferredPowerConsumption() {
		return wrapped.getPreferredPowerConsumption();
	}
	...
	public int getPreferredResponseTime() {
		return wrapped.getPreferredResponseTime();
	}
	...
	public boolean isAddressInfoRequired() {
		return wrapped.isAddressInfoRequired();
	}
	...
	public boolean isAllowedToCost() {
		return wrapped.isAllowedToCost();
	}
	...
	public boolean isAltitudeRequired() {
		return wrapped.isAltitudeRequired();
	}
	...
	public boolean isSpeedAndCourseRequired() {
		return wrapped.isSpeedAndCourseRequired();
	}
	...
	public void setAddressInfoRequired(boolean addressInfoRequired) {
		wrapped.setAddressInfoRequired(addressInfoRequired);
	}
	...
	public void setAltitudeRequired(boolean altitudeRequired) {
		wrapped.setAltitudeRequired(altitudeRequired);
	}
	...
	public void setCostAllowed(boolean costAllowed) {
		wrapped.setCostAllowed(costAllowed);
	}
	...
	public void setHorizontalAccuracy(int accuracy) {
		wrapped.setHorizontalAccuracy(accuracy);
	}
	...
	public void setPreferredPowerConsumption(int level) {
		wrapped.setPreferredPowerConsumption(level);
	}
	...
	public void setPreferredResponseTime(int time) {
		wrapped.setPreferredResponseTime(time);
	}
	...
	public void setSpeedAndCourseRequired(boolean speedAndCourseRequired) {
		wrapped.setSpeedAndCourseRequired(speedAndCourseRequired);
	}
	...
	public void setVerticalAccuracy(int accuracy) {
		wrapped.setVerticalAccuracy(accuracy);
	}
